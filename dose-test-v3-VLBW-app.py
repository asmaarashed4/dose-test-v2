...
st.title("Dose calculator for vancomycin in VLBW neonates, Frymoyer model updated for VLBW")
...
#input 5
 ...
 if dosing_freruency == 8.00:
    ...
    drug_clearance = (0.16*((WT/2.9)**0.75)) * ((1/SC)**0.267) * ((PMA**4.42)/ ((PMA**4.42)+(26.3**4.42)))
